export const SPANISH_BIOGRAPHY_PARAGRAPHS = {
  firstParagraph: {
    firstSentence: `Hola!. Me llamo `,
    name: `Gabriel `,
    secondSentence: `soy un `,
    role: `ingeniero en informática `,
    thirdSentence: `residente en Chile.`
  },
  ...
  memeQuote: `"No pases un cambio a producción un día viernes."`
}

export const ENGLISH_BIOGRAPHY_PARAGRAPHS = {
  firstParagraph: {
    firstSentence: `Heya!. My name is `,
    name: `Gabriel `,
    secondSentence: `a `,
    role: `software engineer `,
    thirdSentence: `based in Chile.`
  },
  secondParagraph: `I enjoy developing new products from start to finish,
